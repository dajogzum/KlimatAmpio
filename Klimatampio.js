			...
			xhttp.setRequestHeader("Authorization", "Basic " + btoa("admin:ampio"));
  			...
  			xhttp.onreadystatechange = function() {
				...
				var cis = json[cisid].stan;
      				document.getElementById("klimatampio").innerHTML = "<table class='tg'><tr><td class='tg-baqh'><img class='icon-klimat' src='temp.png'><span class='txt-klimat'>Temperatura</span></br><span class='txt-klimat big-klimat'>"+temp+"</span></td><td class='tg-baqh'><img class='icon-klimat' src='drop.png'><span class='txt-klimat'>Wilgotność</span></br><span class='txt-klimat big-klimat'>"+wilg+"</span></td><td class='tg-baqh'><img class='icon-klimat' src='press.png'><span class='txt-klimat'>"+cis+"</span></br><span class='txt-klimat big-klimat'>1001 hPa</span></td></tr></table>";
    				}
  			}
  		}, 3000)
	},
