			...
			xhttp.setRequestHeader("Authorization", "Basic " + btoa("admin:ampio"));
  			...
  			xhttp.onreadystatechange = function() {
				...
				var cis = json[cisid].stan;
      				document.getElementById("klimatampio").innerHTML = "Temperatura: <span class='bright'>"+temp+"°C</span></br>Wilgotność: <span class='bright'>"+wilg+"%</span></br>Ciśnienie: <span class='bright'>"+cis+" hPa</span>";
    				}
  			}
  		}, 3000)
	},
